  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
          ...
          <form onSubmit={onSubmitHandler} className='flex justify-center mx-auto max-w-lg max-sm:scale-75 border border-gray-300 bg-white rounded overflow-hidden'>
          ...
          <div className='text-center'>
            {
              input && <button onClick={onClear} className='border font-light text-xs py-1 px-3 mt-2 rounded-sm shadow-custom-sm cursor-pointer'>Clear Search</button>
            }
          </div>
